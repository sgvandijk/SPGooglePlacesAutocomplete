Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/sgvandijk/SPGooglePlacesAutocomplete"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.authors      = { "Matej Bukovinski" => "matej@bukovinski.com", "Chris Chen" => "chrischen79@gmail.com", "Sander van Dijk" => "sgvandijk@gmail.com" }

  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/sgvandijk/SPGooglePlacesAutocomplete.git", :tag => '1.0.4.1'}
